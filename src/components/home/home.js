...
function Home() {
  ...
  function getAllContacts() {
    ...
    //getting all contacts from the server
  ...
  const postNewContact = () => {
    ...
    //maybe I should have a validation for the length of the string because otherwise the user will have the ability to add 20-symbols name
